              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-center">
                  ...
                  <label htmlFor="card" className="ml-4 flex gap-2 cursor-pointer">
                    <Image src="https://readymadeui.com/images/visa.webp" width={30} height={8} alt="card1" />
                    <Image src="https://readymadeui.com/images/american-express.webp" width={30} height={8}alt="card2" />
                    <Image src="https://readymadeui.com/images/master.webp" width={30} height={8} alt="card3" />
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="paypal" className="ml-4 flex gap-2 cursor-pointer">
                    <Image src="https://readymadeui.com/images/paypal.webp" width={50} height={15} alt="paypalCard" />
                  </label>
                </div>
              </div>
